...
<div class = "profiles">
  <div class = "profile">
    ...
    <h3 class = "user-name">Mateo Lopez-Castillo</h3>
    <h5>Elite Chess Player</h5>
    <p>Makes Magnus Carlsen look like a kindergartener and he's no slouch when it comes to coding! </p>
  </div>
...
<div class = "profiles">
  <div class = "profile">
    <img src = "https://ca.slack-edge.com/T0351JZQ0-U03TBMN8AKU-39fc15bc733e-512" class = "profile-img">
    </img>
